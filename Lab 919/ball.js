function ballClass(x, y, vx, vy, ax, ay, radius, s1, s2, s3, c1, c2, c3){
  this.radius = radius;
...
ballClass.prototype.render = function(){
  ...
  ctx.lineTo(this.loc.x, this.loc.y+(this.radius*Math.random()+3));
  ctx.lineTo(this.loc.x+(this.radius*Math.random()+3), this.loc.y);
  ctx.closePath();
